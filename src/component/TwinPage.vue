...
<template>
    <div class="container" style= "text-align: center; width: auto; height: auto;">
      <div>
        <iframe  src="http://52.36.71.154:3000/d-solo/ENk1jS84k/test?orgId=1&refresh=20s&from=1694571261713&to=1694592861713&panelId=2" width="100%" height="400px" frameborder="0"></iframe>
      </div>
    </div>  
  </template>
